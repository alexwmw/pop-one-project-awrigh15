...
def test_is_legal_move_by_musketeer():
    ...
    assert is_legal_move_by_musketeer((0, 3), up) == False    # out of bounds
...
def test_all_possible_moves_for():
    set_board(board1)
    # All possible moves for R, M in board1 as lists:
    M_moves = [
    ((1, 3), left),
    ((1, 3), down),
    ((2, 2), left),
    ...
    set_board(board3)
    # All possible moves for R, M in board3 as lists:
    M_moves = []
    R_moves = [
    ((1, 2), up),
    ((1, 2), left),
